...
def parse_args():
    ...
    parser.add_argument('--data_path', nargs='?', default='data/books/', help='Input data path, movielens, netflix, books')  
    parser.add_argument('--seed', type=int, default=2022, help='Random seed')
    parser.add_argument('--dataset', nargs='?', default='books_llmrec_format', help='Choose a dataset from {books_llmrec_format, netflix_valid_item, ml-1m_llmrec_format}')
    ...
    parser.add_argument('--early_stopping_patience', type=int, default=10, help='Early Stop Patience')                   
    ...
    parser.add_argument('--Ks', nargs='?', default='[1062]', help='K value of ndcg/recall @ k, Max len of Ground truth history of specific user')
    ...
    parser.add_argument('--mask_rate', type=float, default=0.01, help='Mask rate')   
    parser.add_argument('--mask', type=bool, default=True, help='If mask')   
    ...
    parser.add_argument('--tau', default=0.5, type=float, help='MultiModal tau')   
    ...
    parser.add_argument('--att_re_rate', type=float, default=1e-5, help='Attribute restoration rate')        
