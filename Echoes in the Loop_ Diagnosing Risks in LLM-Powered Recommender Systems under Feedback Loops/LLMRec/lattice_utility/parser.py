...
def parse_args():
    ...
    parser.add_argument('--data_path', nargs='?', default='data/ml-1m',
                        help='data/ml-1m, data/books/')
    parser.add_argument('--seed', type=int, default=42,
                        help='Random seed')
    parser.add_argument('--dataset', nargs='?', default='ml-1m_llmrec_format',
                        help='Choose a dataset from {grocery, cloth, sport, netflix, sports, baby, clothing}, ml-1m_llmrec_format, books_llmrec_format')
